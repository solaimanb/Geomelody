...
import AudioFiles from "../lib/audio/AudioFiles";
...
const Home = () => {
  ...
  const handleClick = (event) => {
    ...
    if (AudioFiles[id]) {
      AudioFiles[id].play();
      setCurrentAudio(AudioFiles[id]);
      setSelectedCountry(event.target.getAttribute("name"));
    }
  };
  ...
  return (
    <div name="">
      {/* Render Tooltip */}
      {selectedCountry && (
        <div className="fixed left-10 text-[#369034] font-bold uppercase">
          {selectedCountry}
        </div>
      )}
